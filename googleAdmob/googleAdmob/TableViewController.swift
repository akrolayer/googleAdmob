...
//  googleAdmob
//
//  Created by akrolayer on 2020/05/22.
...
class TableViewController: UITableViewController,GADBannerViewDelegate,GADInterstitialDelegate {
    ...
    var textArray = ["顔文字0","顔文字1","顔文字2","顔文字3","インターステイシャル広告"]
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if indexPath.row == 0{
            ...
            bannerView.adUnitID = "ca-app-pub-7862666518730942/2535366798"
    ...
    func createAndLoadInterstitial() -> GADInterstitial{
        var interstitial = GADInterstitial(adUnitID:"ca-app-pub-7862666518730942/7787693475")
